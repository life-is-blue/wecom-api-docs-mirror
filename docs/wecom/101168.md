...
| --- | --- | --- |
| sheet_id | string | 工作表唯一标识 |
| grid_data | object([GridData](./97661.md#GridData)) | 写入指定区域的数据 |
...
| --- | --- | --- |
| sheet_id | string | 工作表唯一标识 |
| dimension | string | 声明删除的维度为行或者列。详见 [Dimension](./97661.md#Dimension) |
...
| 参数名 | 数据类型 | 描述 |
| --- | --- | --- |
| properties | object([Properties](./97711.md#Properties)) | 新增子表的属性 |
