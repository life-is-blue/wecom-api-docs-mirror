...
使用企业微信 JS-SDK：[@wecom/jssdk](#24229) `>=2.3.2`

### API接口

[ww.createWWLoginPanel](./98268.md)
...
* **4. 登录组件支持自定义样式吗？**
  不支持自定义登录组件样式，可通过 [`panel_size`](./98268.md) 参数定义登录组件面板大小
* **5. 提示“页面域名与登录授权域名不一致”**
...
可通过[`panel_size`](./98268.md)字段指定为更小的面板 320x380px
