...
| body.bot_id | string | 是 | 智能机器人的 BotID，获取方法参考[配置说明](#%E9%95%BF%E8%BF%9E%E6%8E%A5%E9%85%8D%E7%BD%AE%E8%AF%B4%E6%98%8E) |
...
| body.from.userid | string | 消息发送者的 userid。如果智能机器人创建者为企业超级管理员，则此字段为明文userid，否则此字段为企业主体下的加密userid（可通过[自建应用与智能机器人的对接](./101521.md)转为明文userid） |
...
| body.chatid | string | 会话 ID，仅群聊类型时返回 |
| body.chattype | string | 会话类型，`single` 单聊 / `group` 群聊 |
| body.from.userid | string | 事件触发者的 userid。如果智能机器人创建者为企业超级管理员，则此字段为明文userid，否则此字段为企业主体下的加密userid（可通过[自建应用与智能机器人的对接](./101521.md)转为明文userid） |
...
| 事件类型 | eventtype | 说明 |
| --- | --- | --- |
| [进入会话事件](#59058/%E8%BF%9B%E5%85%A5%E4%BC%9A%E8%AF%9D%E4%BA%8B%E4%BB%B6) | enter_chat | 用户当天首次进入机器人单聊会话 |
| [模板卡片事件](#59058/%E6%A8%A1%E6%9D%BF%E5%8D%A1%E7%89%87%E4%BA%8B%E4%BB%B6) | template_card_event | 用户点击模板卡片按钮 |
| [用户反馈事件](#59058/%E7%94%A8%E6%88%B7%E5%8F%8D%E9%A6%88%E4%BA%8B%E4%BB%B6) | feedback_event | 用户对机器人回复进行反馈 |
| [连接断开事件](#%E8%BF%9E%E6%8E%A5%E6%96%AD%E5%BC%80%E4%BA%8B%E4%BB%B6%E6%A0%BC%E5%BC%8F%E7%A4%BA%E4%BE%8B) | disconnected_event | 当有新连接建立时，系统会给旧连接发送该事件并且主动断开旧连接 |
...
收到消息回调（aibot_msg_callback）后，开发者可使用 `aibot_respond_msg` 命令回复消息。支持流式消息、模板卡片、markdown、文件消息、语音消息、图片消息和视频消息。
...
| 消息类型 | msgtype | 说明 |
| --- | --- | --- |
| 模板卡片 | template_card | 模板卡片消息，详见[模板卡片](./101463.md#%E6%A8%A1%E6%9D%BF%E5%8D%A1%E7%89%87%E6%B6%88%E6%81%AF) |
| Markdown | markdown | Markdown 格式消息，详见[markdown](./101463.md#markdown%E6%B6%88%E6%81%AF) |
| 文件消息 | file | 普通文件消息，详见[文件消息](./101463.md#%E6%96%87%E4%BB%B6%E6%B6%88%E6%81%AF) |
| 图片消息 | image | 图片消息，详见[图片消息](./101463.md#%E5%9B%BE%E7%89%87%E6%B6%88%E6%81%AF) |
| 语音消息 | voice | 语音消息，详见[语音消息](./101463.md#%E8%AF%AD%E9%9F%B3%E6%B6%88%E6%81%AF) |
| 视频消息 | video | 视频消息，详见[视频消息](./101463.md#%E8%A7%86%E9%A2%91%E6%B6%88%E6%81%AF) |
...
| template_card | Object | 是 | 模板卡片结构体，参考[模板卡片类型](./101032.md)中类型说明 |
| template_card.feedback.id | String | 否 | 若字段不为空值，回复的消息被用户反馈时候会触发[回调事件](#59058/%E7%94%A8%E6%88%B7%E5%8F%8D%E9%A6%88%E4%BA%8B%E4%BB%B6)。有效长度为 256 字节以内，必须是 utf-8 编码。 |
...
| media_id | 是 | 文件id，可以调用[上传临时素材](./101463.md#%E4%B8%8A%E4%BC%A0%E4%B8%B4%E6%97%B6%E7%B4%A0%E6%9D%90)接口获取 |
...
| media_id | 是 | 图片媒体文件id，可以调用[上传临时素材](./101463.md#%E4%B8%8A%E4%BC%A0%E4%B8%B4%E6%97%B6%E7%B4%A0%E6%9D%90)接口获取 |
...
| media_id | 是 | 语音文件id，可以调用[上传临时素材](./101463.md#%E4%B8%8A%E4%BC%A0%E4%B8%B4%E6%97%B6%E7%B4%A0%E6%9D%90)接口获取 |
...
| media_id | 是 | 视频媒体文件id，可以调用[上传临时素材](./101463.md#%E4%B8%8A%E4%BC%A0%E4%B8%B4%E6%97%B6%E7%B4%A0%E6%9D%90)接口获取 |
...
| body.total_size | int | 是 | 文件总大小，最少5个字节。图片文件不超过10MB，语音文件不超过2MB，视频文件不超过10MB，普通文件不超过20MB |
