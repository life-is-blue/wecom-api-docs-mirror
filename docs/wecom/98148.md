...
| invitees | 否 | object | 邀请参与会议的成员。人数上限以指定的「管理员」可预约的人数上限来校验： 普通企业与会人员最多100 付费企业由企业选购的在线会议室或高级账号对应的容量决定，但最多不能超过300人，若超过300人请调用[更新会议受邀成员列表](#45821)接口 **注意：** 任何userid不合法或者不在应用可见范围，直接报错。 |
...
| meetingid | string | 会议id，通过此id可调用“进入会议”接口(包括[小程序接口](./93815.md)和[JS-SDK接口](./93807.md))，以向参会人提供便捷入会入口 |
