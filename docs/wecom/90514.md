...
在注册应用身份信息时，开发者需要提供对应的签名函数。该函数需要根据当前页面的 URL 和应用的 Secret 等信息生成 JS-SDK 签名并返回相关信息。详见 [JS-SDK 签名算法](./90245.md)。
...
应用在原有签名函数的基础上，需要额外提供应用的AgentID以及应用签名函数。和原有的签名函数不同，应用签名函数需要使用应用的 jsapi_ticket。见 [获取应用 jsapi_ticket](./90245.md#%E8%8E%B7%E5%8F%96%E5%BA%94%E7%94%A8-jsapi-ticket)。
...
jsapi_ticket 的获取方法可以参考[获取企业 jsapi_ticket](./90245.md#%E8%8E%B7%E5%8F%96%E4%BC%81%E4%B8%9A-jsapi-ticket)和[获取应用 jsapi_ticket](./90245.md#%E8%8E%B7%E5%8F%96%E5%BA%94%E7%94%A8-jsapi-ticket)，在开发阶段我们也可以通过以下命令快速获取：
