...
| solitaire_type | 用于区分接龙发起消息与接龙参与消息，101接龙发起消息、102接龙参与消息。Uint32 类型 |
| solitaire_content | 接龙内容。String类型 |
...
| msg_type | 笔记内容类型：文本text、图片image、语音voice、视频video、位置location、文件file。String类型 |
