...
| 应用类型 | 权限要求 | 接收事件开关 |
| --- | --- | --- |
| 自建应用 | 配置到「[客户联系- 可调用接口的应用](./92109.md#%E9%85%8D%E7%BD%AE%E5%8F%AF%E8%B0%83%E7%94%A8%E6%8E%A5%E5%8F%A3%E7%9A%84%E5%BA%94%E7%94%A8)」中 | [外部联系人变更回调](#12977/%E5%BC%80%E5%90%AF%E6%8E%A5%E6%94%B6%E6%B6%88%E6%81%AF) |
| 代开发应用 | 具有「客户联系->客户基础信息」权限 | 无 |
| 第三方应用 | 具有「客户联系->客户基础信息」权限 | 无 |

特别注意：

* 接收[客户接替失败事件](./92130.md#%E5%AE%A2%E6%88%B7%E6%8E%A5%E6%9B%BF%E5%A4%B1%E8%B4%A5%E4%BA%8B%E4%BB%B6)的应用，需具有“企业客户权限->客户联系->分配在职或离职成员的客户”权限
* 接收[企业客户标签创建事件](./92130.md#%E4%BC%81%E4%B8%9A%E5%AE%A2%E6%88%B7%E6%A0%87%E7%AD%BE%E5%88%9B%E5%BB%BA%E4%BA%8B%E4%BB%B6)、[企业客户标签变更事件](./92130.md#%E4%BC%81%E4%B8%9A%E5%AE%A2%E6%88%B7%E6%A0%87%E7%AD%BE%E5%8F%98%E6%9B%B4%E4%BA%8B%E4%BB%B6)、[企业客户标签删除事件](./92130.md#%E4%BC%81%E4%B8%9A%E5%AE%A2%E6%88%B7%E6%A0%87%E7%AD%BE%E5%88%A0%E9%99%A4%E4%BA%8B%E4%BB%B6)的应用，需具有“企业客户权限->客户联系->管理企业客户标签”权限

## 添加企业客户事件

[配置了客户联系功能](./92109.md#%E5%BC%80%E5%A7%8B%E5%BC%80%E5%8F%91)的成员添加外部联系人时，回调该事件
...
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为add\_external\_contact |
| UserID | 企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |
| State | 添加此用户的[「联系我」](./92228.md#%E9%85%8D%E7%BD%AE%E5%AE%A2%E6%88%B7%E8%81%94%E7%B3%BB%E3%80%8C%E8%81%94%E7%B3%BB%E6%88%91%E3%80%8D%E6%96%B9%E5%BC%8F)方式配置的state参数，或[在获客链接中指定的customer\_channel参数](./42923.md)，可用于识别添加此用户的渠道 |
| WelcomeCode | 欢迎语code，可用于[发送欢迎语](./92137.md) |

> 企业可以根据ExternalUserID调用“[获取客户详情](./92114.md)”读取详情。
> 企业可以通过[配置客户联系「联系我」方式](./92228.md#%E9%85%8D%E7%BD%AE%E5%AE%A2%E6%88%B7%E8%81%94%E7%B3%BB%E3%80%8C%E8%81%94%E7%B3%BB%E6%88%91%E3%80%8D%E6%96%B9%E5%BC%8F)接口来指定State参数，或[在获客链接中指定customer\_channel参数](./42923.md)，当有客户通过对应的联系方式添加企业成员时，State即为用户配置的state/customer\_channel参数。
...
[配置了客户联系功能](./92109.md#%E5%BC%80%E5%A7%8B%E5%BC%80%E5%8F%91)的成员修改外部联系人的备注、手机号或标签时，回调该事件
...
| MsgType | 消息的类型，此时固定为event |
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为edit\_external\_contact |
| UserID | 企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |

## 外部联系人免验证添加成员事件

外部联系人添加了[配置了客户联系功能](./92109.md#%E5%BC%80%E5%A7%8B%E5%BC%80%E5%8F%91)且开启了**免验证**的成员时（此时成员尚未确认添加对方为好友），回调该事件
...
| MsgType | 消息的类型，此时固定为event |
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为add\_half\_external\_contact |
| UserID | 企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |
| State | 添加此用户的[「联系我」](./92228.md#%E9%85%8D%E7%BD%AE%E5%AE%A2%E6%88%B7%E8%81%94%E7%B3%BB%E3%80%8C%E8%81%94%E7%B3%BB%E6%88%91%E3%80%8D%E6%96%B9%E5%BC%8F)方式配置的state参数，或在[获客链接中指定的customer\_channel参数](./42923.md)，可用于识别添加此用户的渠道 |
| WelcomeCode | 欢迎语code，可用于[发送欢迎语](./92137.md) |
...
[配置了客户联系功能](./92109.md#%E5%BC%80%E5%A7%8B%E5%BC%80%E5%8F%91)的成员删除外部联系人时，回调该事件
...
| MsgType | 消息的类型，此时固定为event |
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为del\_external\_contact |
| UserID | 企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |
...
[配置了客户联系功能](./92109.md#%E5%BC%80%E5%A7%8B%E5%BC%80%E5%8F%91)的成员**被外部联系人删除**时，回调该事件
...
| MsgType | 消息的类型，此时固定为event |
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为del\_follow\_user |
| UserID | 企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |
...
| MsgType | 消息的类型，此时固定为event |
| Event | 事件的类型，此时固定为change\_external\_contact |
| ChangeType | 此时固定为transfer\_fail |
| FailReason | 接替失败的原因, customer\_refused-客户拒绝， customer\_limit\_exceed-接替成员的客户数达到上限 |
| UserID | 接替失败的企业服务人员的UserID |
| ExternalUserID | 外部联系人的userid，注意不是企业成员的账号 |

> 如果此客户在企业内仍有其他在职的跟进人，则企业仍可以根据ExternalUserID调用“[获取客户详情](./92114.md)”读取详情，否则无法获取。

## 客户群创建事件

有新增客户群时，回调该事件。收到该事件后，企业可以调用[获取客户群详情](./92122.md)接口获取客户群详情。
...
客户群被修改后（群名变更，群成员增加或移除，群主变更，群公告变更），回调该事件。收到该事件后，企业需要再调用[获取客户群详情](./92122.md)接口，以获取最新的群详情。
...
| UpdateDetail | 变更详情。目前有以下几种： add\_member : 成员入群 del\_member : 成员退群  change\_owner : 群主变更 change\_name : 群名变更 change\_notice : 群公告变更 |
...
企业/管理员创建客户标签/标签组时（包括规则组的标签），回调此事件。收到该事件后，企业需要调用[获取企业标签库](#17298/%E8%8E%B7%E5%8F%96%E4%BC%81%E4%B8%9A%E6%A0%87%E7%AD%BE%E5%BA%93)来获取标签/标签组的详细信息。
