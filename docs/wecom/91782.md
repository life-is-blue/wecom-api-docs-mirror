...
**单聊请求地址：**https://qyapi.weixin.qq.com/cgi-bin/msgaudit/check\_single\_agree?access\_token=ACCESS\_TOKEN
...
**权限说明：**
企业需要使用会话内容存档应用secret所获取的accesstoken来调用（[accesstoken如何获取？](#10013/%E7%AC%AC%E4%B8%89%E6%AD%A5%EF%BC%9A%E8%8E%B7%E5%8F%96access_token)）；
...
| errmsg | 对返回码的文本描述内容 |
| agreeinfo | 同意情况 |
| agree\_status | 同意:"Agree"，不同意:"Disagree" |
| status\_change\_time | 同意状态改变的具体时间，utc时间 |

**群聊请求地址：**https://qyapi.weixin.qq.com/cgi-bin/msgaudit/check\_room\_agree?access\_token=ACCESS\_TOKEN
