...
**请求方式：** POST（**HTTPS**）
**请求地址：** https://qyapi.weixin.qq.com/cgi-bin/meeting/vip/submit_batch_add_job?access_token=ACCESS_TOKEN
...
**请求方式：** POST（**HTTPS**）
**请求地址：** https://qyapi.weixin.qq.com/cgi-bin/meeting/vip/batch_add_job_result?access_token=ACCESS_TOKEN
