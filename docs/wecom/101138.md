...
当用户与智能机器人进行交互时，企业微信会将相关的[交互事件](./57141.md)回调到开发者设置的回调URL，回调中会返回一个 response_url 。开发者可根据事件类型先做出相应的[响应](#59068/%E5%9B%9E%E5%A4%8D%E7%94%A8%E6%88%B7%E6%B6%88%E6%81%AF)，待处理完业务逻辑后，使用response_url主动调用接口回复消息，实现丰富的自定义功能。
