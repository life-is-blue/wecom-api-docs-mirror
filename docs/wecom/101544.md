...
* 必须先使用 `ww.register` 进行[应用身份注册](./90514.md#%E5%BA%94%E7%94%A8%E8%BA%AB%E4%BB%BD%E6%B3%A8%E5%86%8C)
...
| 参数 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| success | (result: SuccessResult) => void | 否 | 调用成功的回调函数，详见 [`success` 回调入参](#success-%E5%9B%9E%E8%B0%83%E5%85%A5%E5%8F%82) |
...
* [数据与智能专区文档选择](./101497.md)：选择微盘 doc 文档（同能力域兄弟接口）
