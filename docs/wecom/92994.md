...
| errcode | 返回码 |
| errmsg | 对返回码的文本描述内容 |
| external_contact_list.external_contact | 客户的基本信息，可以参考[获取客户详情](./92114.md) |
| external_contact_list.follow_info | 企业成员客户跟进信息，可以参考[获取客户详情](./92114.md)，但标签信息只会返回企业标签和规则组标签的tag_id，个人标签将不再返回 |
