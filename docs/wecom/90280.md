...
这里需要特别注意的是使用微信公众号的oauth流程进行公众号支付的场景不能在企业微信中直接发起支付，区别在于此处需要使用企业微信的oauth流程先获取用户的userid（参考文档：[企业微信oauth流程](#90000/90135/91020)），再通过接口将userid转换为openid，具体的转换方式可以参考以下文档：[userid与openid互换](./11279.md "userid与openid互换")
...
此处的验证方式和微信公众平台的网页开发签名算法一致，更多关于JSAPI签名算法的完整流程，请参考文档 ：[JS-SDK签名算法](#10029/%E9%99%84%E5%BD%951-JS-SDK%E4%BD%BF%E7%94%A8%E6%9D%83%E9%99%90%E7%AD%BE%E5%90%8D%E7%AE%97%E6%B3%95 "JS-SDK签名算法")
...
"Mozilla/5.0 (iPhone; CPU iPhone OS 10\_3\_2 like Mac OS X) AppleWebKit/603.2.4 (KHTML, like Gecko) Mobile/14F89 wxwork/2.1.0 MicroMessenger/6.3.22"
