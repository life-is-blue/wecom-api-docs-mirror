...
<xml>
   ...
   <ChangeType><![CDATA[pstn_status_update]]></ChangeType>
   <MeetingId><![CDATA[wcjgewCwAAqeJcPI1d8Pwbjt7nttzAAA]]></MeetingId>
   <PstnStatus><![CDATA[START_ACCEPT]]></PstnStatus>
</xml>
```
...
| MeetingId | 会议ID |
| PstnStatus | PSTN外呼状态。 START\_INVITE: 开始邀请 START\_ACCEPT: 用户接听 LEAVE\_WITHOUT\_ACCEPT: 用户无接听挂断或拒绝 LEAVE\_WITH\_ACCEPTED: 用户已接听挂断 CANCLE\_INVITE: 呼叫中邀请人主动取消 |
