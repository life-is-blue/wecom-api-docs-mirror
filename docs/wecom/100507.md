...
在用户分享网页或小程序前，先调用[setShareAttr](#56726)，将本页面的转发声明为shareticket消息。声明之后，该页面被转发之后都有shareticket属性，转发途径包括：右上角菜单、调用[shareAppMessage](#14911/%E8%87%AA%E5%AE%9A%E4%B9%89%E8%BD%AC%E5%8F%91%E5%88%B0%E4%BC%9A%E8%AF%9D)接口、聊天附件栏页面的底部“发送”按钮、聊天附件栏或聊天工具栏调用[sendChatMessage](#29574)接口等。
