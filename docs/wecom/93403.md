...
**请求方式：** POST（**HTTPS**）
**请求地址：** https://qyapi.weixin.qq.com/cgi-bin/corpgroup/corp/list\_app\_share\_info?access\_token=ACCESS\_TOKEN
...
| business\_type | 否 | 填0则为企业互联/局校互联，填1则表示上下游企业 |
...
| corp\_list | 应用共享信息 |
| corp\_list.corpid | 下级/下游企业corpid |
| corp\_list.corp\_name | 下级/下游企业名称 |
| corp\_list.agentid | 下级/下游企业应用id |
