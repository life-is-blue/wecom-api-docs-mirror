...
**请求地址：** https://qyapi.weixin.qq.com/cgi-bin/contactrule/update?access\_token=ACCESS\_TOKEN
...
| rules.rule\_id | 是 | 规则唯一标识 |
| rules.rule\_type | 是 | 规则类型，不能更新规则类型。 1 - 隐藏部门/成员 2 - 限制查看外部门 3 - 限制查看所有人 |
