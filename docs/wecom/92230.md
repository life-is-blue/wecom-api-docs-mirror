...
三、除[user/create](#10018)、[user/update](#10020)外，我们在 [user/get](#10019)，[externalcontact/get](./92114.md) 等相关接口也增加了external_profile字段，该字段含义在本篇统一描述。
...
| wechat_channels | 视频号属性。须从企业绑定到企业微信的视频号中选择，可在“我的企业”页中查看绑定的视频号。第三方仅通讯录应用可获取；对于非第三方创建的成员，第三方通讯录应用也不可获取。注意：[externalcontact/get](./92114.md)不返回该字段 | 否 |
