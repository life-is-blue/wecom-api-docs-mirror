...
**请求方式：** POST（**HTTPS**）
**请求地址：** https://qyapi.weixin.qq.com/cgi-bin/chatdata/open\_debug\_mode?access\_token=ACCESS\_TOKEN
...
| 依赖的参数 | 说明 |
| --- | --- |
| access\_token | 应用的access\_token，注意必须确保在有效时间内，一般是2小时 |
| debug\_token | 程序的调试凭证 |
