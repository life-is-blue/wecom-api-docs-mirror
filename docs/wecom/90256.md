...
> 返回的图片URL，仅能用于[图文消息](#10167/%E5%9B%BE%E6%96%87%E6%B6%88%E6%81%AF)正文中的图片展示，或者给客户发送欢迎语等；若用于非企业微信环境下的页面，图片将被屏蔽。
> 每个企业每月最多可上传3000张图片，每天最多可上传1000张图片

**请求方式：**POST（**HTTPS**）
**请求地址：**https://qyapi.weixin.qq.com/cgi-bin/media/uploadimg?access\_token=ACCESS\_TOKEN
