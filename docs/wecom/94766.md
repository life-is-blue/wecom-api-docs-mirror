...
接口使用说明详见“[wx.qy.getContext](./94321.md)”，在客服工具栏里返回的entry值是single_kf_tools，具体如下：
...
接口使用说明详见“[wx.qy.getCurExternalContact](./93568.md)”，在客服工具栏里调用该接口，自建应用与第三方应用所需的权限有所不同，具体如下：
...
接口使用说明详见“[wx.qy.sendChatMessage](./94370.md)”，在客服工具栏里调用该接口，自建应用与第三方应用所需的权限有所不同，具体如下：
...
> 需要从客服工具栏进入页面才可调用，否则会报错：unsupported msgtype，可先通过调用“[wx.qy.getContext](./94321.md)”来判断进入小程序的入口。
