...
2. **noncestr:** 随机字符串
3. **timestamp:** 当前时间戳，单位为秒
4. **url:** 当前页面的 URL，不包含“#”及后面部分
...
| 参数 | 必须 | 说明 |
| --- | --- | --- |
| access_token | 是 | 调用接口凭证， 企业内部开发，获取方式参考“[获取 access_token](#15074)”  第三方应用开发，获取方式参考“[获取企业凭证](#14944)” |
...
| 参数 | 必须 | 说明 |
| --- | --- | --- |
| access_token | 是 | 应用的调用接口凭证， 企业内部开发，获取方式参考“[获取 access_token](#15074)”  第三方应用开发，获取方式参考“[获取企业凭证](#14944)” |
