...
| 参数 | 必须 | 说明 |
| --- | --- | --- |
| access_token | 是 | 调用接口凭证，见[获取access_token](#15074) |
...
| new_begin | 开始时间,unix时间戳。**当type 为halfday时，取值只能为固定两个时间点 上午：当天00:00:00点时间戳 下午：当天12:00:00时间戳** |
| new_end | 结束时间，unix时间戳。 **当type 为halfday时，取值只能为固定两个时间点 上午：当天00:00:00点时间戳 下午：当天12:00:00时间戳** |
