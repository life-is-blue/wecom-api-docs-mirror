...
| 参数 | 必须 | 说明 |
| --- | --- | --- |
| launch_code | 是 | 唤起页面的code，可通过[获取唤起企业微信code](#%E8%8E%B7%E5%8F%96launch_code)接口获取 |
...
| errcode | 返回码 |
| errmsg | 对返回码的文本描述内容 |
| launch_code | 唤起页面的code，5分钟内有效，只能消费一次。用于[URI scheme 客户端协议](#schema%E5%AE%9A%E4%B9%89)的launch_code参数 |
