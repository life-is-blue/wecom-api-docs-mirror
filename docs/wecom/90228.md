...
| logo_mediaid | 否 | 企业应用头像的mediaid，通过[素材管理](./10112.md)接口上传图片获得mediaid，上传后会自动裁剪成方形和圆形两个头像 |
| name | 否 | 企业应用名称，长度不超过32个utf8字符 |
| description | 否 | 企业应用详情，长度为4至120个utf8字符 |
| redirect_domain | 否 | 企业应用可信域名。注意：域名需通过所有权校验，否则jssdk功能将受限，此时返回[错误码85005](#10649/%E9%94%99%E8%AF%AF%E7%A0%81%EF%BC%9A85005) |
